...
use futures03::{
    self, compat::Future01CompatExt, FutureExt as _, SinkExt as _, StreamExt as _, StreamExt,
...
use web3::{
    ...
    types::{
        ...
        FilterBuilder, Log, Trace, TraceFilter, TraceFilterBuilder, Transaction,
...
use super::{
    adapter::{
        ...
        ProviderEthRpcMetrics,
    },
    /*
    adapter::{
        EthGetLogsFilter, EthereumBlockFilter, EthereumCallFilter, EthereumLogFilter,
...
use crate::chain::ethereum::types::{EthereumBlock, EthereumCall, LightEthereumBlock};
use crate::chain::ethereum::{EthereumCallCache, EthereumNetworkIdentifier};
use crate::chain::BlockFinality;
use crate::graph::cheap_clone::CheapClone;
use crate::indexer::blockchain::IngestorError;
                ...
                None => {
                    ...
                    Box::new(
                        ...
                        .map(move |result| {
                            ...
                            let _ = crate::graph::spawn_blocking_allow_panic(move || {
                                cache
