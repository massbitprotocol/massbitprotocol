...
docker build --tag sprise/chain-reader:0.3 -f chain-reader/Dockerfile -t chain-reader .;
docker build --tag sprise/indexer:0.3 -f indexer/Dockerfile -t indexer .;
...
docker push sprise/chain-reader:0.3;
docker push sprise/indexer:0.3;
