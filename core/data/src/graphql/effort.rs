...
use super::shape_hash::shape_hash;
use crate::graphql::QueryLoadManager;
use crate::metrics::{Counter, Gauge, MetricsRegistry};
use crate::prelude::q;
use crate::query::{CacheStatus, QueryExecutionError};
use crate::store::PoolWaitStats;
use massbit_common::prelude::slog::{debug, info, o, warn, Logger};
use massbit_common::prelude::{async_trait::async_trait, lazy_static::lazy_static};
use massbit_common::util::stats::{MovingStats, BIN_SIZE, WINDOW_SIZE};
        ...
        let query_counters = CacheStatus::iter()
            .map(|s| {
                ...
                let counter = registry
                    ...
                    .expect("Failed to register query_counter metrics");
                (s.clone(), counter)
            })
            .collect::<HashMap<_, _>>();
