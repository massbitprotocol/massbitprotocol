...
pub fn api_schema(
    ...
    features: &BTreeSet<IndexerFeature>,
...
fn query_field_for_fulltext(
    ...
    if features.contains(&IndexerFeature::nonFatalErrors) {
...
fn query_fields_for_type(type_name: &str, features: &BTreeSet<IndexerFeature>) -> Vec<Field> {
...
mod tests {
    ...
    fn api_schema_contains_field_order_by_enum() {
        ...
        let schema = api_schema(
            &input_schema,
            &BTreeSet::from_iter(Some(IndexerFeature::nonFatalErrors)),
        )
