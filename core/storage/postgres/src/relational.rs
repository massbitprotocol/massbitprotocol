...
use massbit_data::prelude::{
    q, s, DirectiveFinder, DocumentExt, ObjectTypeExt, QueryExecutionError, StoreError,
};
use massbit_data::schema::{FulltextConfig, FulltextDefinition, Schema, SCHEMA_TYPE_NAME};
use massbit_data::store::chain::{BlockNumber, BLOCK_NUMBER_MAX};
use massbit_data::store::entity::{
    Entity, EntityChange, EntityCollection, EntityFilter, EntityKey, EntityOrder, EntityRange,
    EntityType,
};
use massbit_data::store::value::{ValueType, BYTES_SCALAR};
use massbit_data::store::StoreEvent;
...
impl Layout {
    ...
    pub fn query<T: crate::relational_queries::FromEntityData>(
        ...
        fn log_query_timing(
            ...
            if !*massbit_data::log::LOG_SQL_TIMING {
                return;
            }
