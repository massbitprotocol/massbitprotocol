...
pub const WAITING_FOR_INCOMING_BLOCK_MILLISECOND: u64 = 500;
pub const WAITING_FOR_BUFFER_WRITING_MICROSECOND: u64 = 10;
pub const MAX_JSON_BODY_SIZE: u64 = 1024 * 1024;
pub const INDEXER_PROCESS_THREAD_LIMIT: usize = 5;
lazy_static! {
