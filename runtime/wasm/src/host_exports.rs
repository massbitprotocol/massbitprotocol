...
pub use massbit::runtime::{DeterministicHostError, HostExportError};
use never::Never;
use semver::Version;
...
use massbit::blockchain::DataSource;
...
pub struct HostExports<C: Blockchain> {
    pub(crate) indexer_id: DeploymentHash,
...
impl<C: Blockchain> HostExports<C> {
    ...
    pub(crate) fn store_set(
        ...
        // TODO: get indexer schema and check whether entity is valid
