...
use massbit_data::query::CacheStatus;
// use graph::prelude::*;
use massbit_data::store::chain::{BlockPtr, BLOCK_NUMBER_MAX};
use massbit_data::utils::cache_weight::CacheWeight;
use massbit_data::utils::lfu_cache::LfuCache;

use super::QueryHash;
use crate::introspection::{
    is_introspection_field, IntrospectionResolver, INTROSPECTION_DOCUMENT, INTROSPECTION_QUERY_TYPE,
};
...
pub async fn execute_root_selection_set<R: Resolver>(
    ...
    let run_query = async move {
        ...
        match task_spawn::spawn_blocking_allow_panic(move || {
