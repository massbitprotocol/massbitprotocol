...
//
// 1. Call this function with an operation name (used for logging).
...
// use graph::prelude::{TimeoutError};
// #
...
// # }
//
// fn async_function() -> impl Future<Output=Result<Memes, TimeoutError<()>>> {
//     // Retry on error
//     retry("download memes")
